...
from .nc_decoder import NextCharacterDecoder
...
class MIRROR(BaseModel):
    def __init__(self, num_classes, max_ch=None, iters=0, enc='focalnet',
        ...
        self.sa4enc = sa4enc
        if sa4enc:
            self.sa_layer = SpatialLocalAttentionModule(feat_dim, nhead=8, window_size=25, num_layers=2,
                                                 drop_rate=0.1, proj_drop_rate=0.1)
        self.decoder = NextCharacterDecoder(num_classes, feat_dim, max_ch=max_ch, iters=iters, **kwargs)
