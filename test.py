...
def evaluate(dataloader, net, label_cvter, model_type='vit', accountant=None, need_debug=False, test_speed=False,
             ret_probs=False):
...
def main(config_dict):
    ...
    if not config_dict['test_speed']:
        ...
        md_info = tabulate([acc_list + ['-'] * 3], headers=table_headers + ['Speed', 'Params', 'FLOPs'],
